...
class EmployeeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HighestSalary = channel.unary_unary(
                '/employee_service.EmployeeService/HighestSalary',
                request_serializer=EmployeeService__pb2.EmptyMessage.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeData.FromString,
                )
        self.LowestSalary = channel.unary_unary(
                '/employee_service.EmployeeService/LowestSalary',
                request_serializer=EmployeeService__pb2.EmptyMessage.SerializeToString,
                response_deserializer=EmployeeService__pb2.EmployeeData.FromString,
                )
...
def add_EmployeeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'HighestSalary': grpc.unary_unary_rpc_method_handler(
                    servicer.HighestSalary,
                    request_deserializer=EmployeeService__pb2.EmptyMessage.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeData.SerializeToString,
            ),
            'LowestSalary': grpc.unary_unary_rpc_method_handler(
                    servicer.LowestSalary,
                    request_deserializer=EmployeeService__pb2.EmptyMessage.FromString,
                    response_serializer=EmployeeService__pb2.EmployeeData.SerializeToString,
            ),
    }
...
class EmployeeService(object):
    ...
    def HighestSalary(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/employee_service.EmployeeService/HighestSalary',
            EmployeeService__pb2.EmptyMessage.SerializeToString,
            EmployeeService__pb2.EmployeeData.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def LowestSalary(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/employee_service.EmployeeService/LowestSalary',
            EmployeeService__pb2.EmptyMessage.SerializeToString,
            EmployeeService__pb2.EmployeeData.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
